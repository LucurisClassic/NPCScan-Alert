...
def eventTrigger(unixtimestamp,filename):
	...
	if sys.argv[1] == '-Hinterlands':
		filePicker = 'C:\\Users\\lucuris\\Desktop\\NPCscan_Alert\\Hinterlands.py'
	elif sys.argv[1] == '-Ashenvale':
		filePicker = 'C:\\Users\\lucuris\\Desktop\\NPCscan_Alert\\Ashenvale.py'
	elif sys.argv[1] == '-Feralas':
		filePicker = 'C:\\Users\\lucuris\\Desktop\\NPCscan_Alert\\Feralas.py'
	elif sys.argv[1] == '-Duskwood':
		filePicker = 'C:\\Users\\lucuris\\Desktop\\NPCscan_Alert\\Duskwood.py'
	elif sys.argv[1] == '-Kazzak':
		filePicker = 'C:\\Users\\lucuris\\Desktop\\NPCscan_Alert\\Kazzak.py'
	elif sys.argv[1] == '-Azuregos':
		filePicker = 'C:\\Users\\lucuris\\Desktop\\NPCscan_Alert\\Azuregos.py'
	else:
		filePicker = 'C:\\Users\\lucuris\\Desktop\\NPCscan_Alert\\noZoneSpecified.py' 	
